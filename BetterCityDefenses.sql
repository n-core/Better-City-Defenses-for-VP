...
SELECT  'BUILDING_PALISADES', 'FLAVOR_CITY_DEFENSE', 30 AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='CBPMC_DEFENSES' AND Value= 1);
...
SELECT  'TXT_KEY_BUILDING_PALISADES_HELP',
        ...
        '[NEWLINE][ICON_CITY_STATE] Empire Size Modifier is reduced by 5% in this City.'
        WHERE EXISTS (SELECT * FROM COMMUNITY WHERE Type='CBPMC_DEFENSES' AND Value= 1) UNION ALL
...
INSERT  INTO Building_Flavors (BuildingType, FlavorType, Flavor)
SELECT  'BUILDING_WEAPONS_DEPOT', 'FLAVOR_CITY_DEFENSE', 30 AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='CBPMC_DEFENSES' AND Value= 1) UNION ALL
SELECT  'BUILDING_WEAPONS_DEPOT', 'FLAVOR_ANTIAIR', 30 AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='CBPMC_DEFENSES' AND Value= 1) UNION ALL
SELECT  'BUILDING_WEAPONS_DEPOT', 'FLAVOR_OFFENSE', 20 AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='CBPMC_DEFENSES' AND Value= 1);
...
SELECT  'TXT_KEY_BUILDING_WEAPONS_DEPOT_STRATEGY',
        ...
        '[NEWLINE]The City must already possess an {TXT_KEY_BUILDING_ARSENAL} before a {TXT_KEY_BUILDING_WEAPONS_DEPOT} can be constructed.'
        WHERE EXISTS (SELECT * FROM COMMUNITY WHERE Type='CBPMC_DEFENSES' AND Value= 1) UNION ALL
...
INSERT  INTO Building_Flavors (BuildingType, FlavorType, Flavor)
SELECT  'BUILDING_DEFENSE_SATELLITE', 'FLAVOR_CITY_DEFENSE', 30 AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='CBPMC_DEFENSES' AND Value= 1) UNION ALL
SELECT  'BUILDING_DEFENSE_SATELLITE', 'FLAVOR_ANTIAIR', 25 AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='CBPMC_DEFENSES' AND Value= 1) UNION ALL
SELECT  'BUILDING_DEFENSE_SATELLITE', 'FLAVOR_SCIENCE', 10 AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='CBPMC_DEFENSES' AND Value= 1);
...
SELECT  'TXT_KEY_BUILDING_DEFENSE_SATELLITE_HELP',
        ...
        '[NEWLINE]Maximum of ' || (SELECT MaxPlayerInstances FROM BuildingClasses WHERE Type = 'BUILDINGCLASS_DEFENSE_SATELLITE') || ' of these satellites in your Empire.'
        WHERE EXISTS (SELECT * FROM COMMUNITY WHERE Type='CBPMC_DEFENSES' AND Value= 1) UNION ALL
SELECT  'TXT_KEY_BUILDING_DEFENSE_SATELLITE_STRATEGY',
        ...
        'Maximum of ' || (SELECT MaxPlayerInstances FROM BuildingClasses WHERE Type = 'BUILDINGCLASS_DEFENSE_SATELLITE') || ' of these satellites in your Empire, so make sure to place these in strategic cities.'
        WHERE EXISTS (SELECT * FROM COMMUNITY WHERE Type='CBPMC_DEFENSES' AND Value= 1) UNION ALL
...
INSERT  INTO Building_Flavors (BuildingType, FlavorType, Flavor)
SELECT  'BUILDING_SATELLITE_NETWORK', 'FLAVOR_CITY_DEFENSE', 40 AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='CBPMC_DEFENSES' AND Value= 1) UNION ALL
SELECT  'BUILDING_SATELLITE_NETWORK', 'FLAVOR_WONDER', 25 AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='CBPMC_DEFENSES' AND Value= 1) UNION ALL
SELECT  'BUILDING_SATELLITE_NETWORK', 'FLAVOR_SCIENCE', 10 AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='CBPMC_DEFENSES' AND Value= 1) UNION ALL
SELECT  'BUILDING_SATELLITE_NETWORK', 'FLAVOR_PRODUCTION', 5 AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='CBPMC_DEFENSES' AND Value= 1);
...
INSERT  INTO Building_BuildingClassYieldChanges
SELECT  'BUILDING_DEFENSE_SATELLITE', 'BUILDINGCLASS_SATELLITE_NETWORK', 'YIELD_SCIENCE', 3
        WHERE EXISTS (SELECT * FROM COMMUNITY WHERE Type='CBPMC_DEFENSES' AND Value= 1) UNION ALL
SELECT  DISTINCT 'BUILDING_SATELLITE_NETWORK', bc.Type, 'YIELD_SCIENCE', 2 FROM BuildingClasses bc
        ...
        AND EXISTS (SELECT * FROM COMMUNITY WHERE Type='CBPMC_DEFENSES' AND Value= 1) UNION ALL
...
SELECT  'TXT_KEY_BUILDING_SATELLITE_NETWORK_STRATEGY',
        ...
        'This can indirectly aide in any type of victory. The value of {TXT_KEY_BUILDING_SATELLITE_NETWORK} increases as you built more {TXT_KEY_BUILDING_DEFENSE_SATELLITE} within the Empire. Build it in your heartland where it will likely be safe.'
        WHERE EXISTS (SELECT * FROM COMMUNITY WHERE Type='CBPMC_DEFENSES' AND Value= 1) UNION ALL
